...
Budget roughly **2 to 3 weeks part-time**. Most of that is data work, not training.
...
Target **1,000 to 2,000 images per class.** Filters that matter:
...
- **Deduplicate by observation ID.** One observation often has 4 to 5 photos of
...
Budget 3 to 5 days. Do it by eye, in batches, with a coffee.
...
Training takes 20 to 60 minutes on Apple Silicon.
