...
enum PlantClass: String, CaseIterable {
    ...
    /// nonisolated because PlantClassifier is an actor and calls this from
    /// off the main actor. Without it, default main actor isolation makes
    /// this a Swift 6 error rather than just a warning.
    nonisolated static func from(label: String) -> PlantClass? {
