...
struct CameraScreen: View {
    ...
    private func cropToQuadrat(_ image: UIImage) -> UIImage {
        guard previewSize != .zero else { return image }
        return image.croppedToQuadrat(squareSide: squareSide, previewSize: previewSize)
    }
    ...
    private func capture() {
        ...
        Task {
            ...
            do {
                ...
                let cropped = cropToQuadrat(full)
