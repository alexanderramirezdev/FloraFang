...
extension CameraService: AVCapturePhotoCaptureDelegate {
    func photoOutput(
        ...
        guard let data = photo.fileDataRepresentation(),
            ...
            continuation?.resume(throwing: IdentificationError.badImage)
            return
        }
        // Normalize orientation up front. Downstream cropping and Vision both
        // get much simpler when imageOrientation is always .up.
