...
//
//  Cropping to the on-screen quadrat square before classification means the
...
extension UIImage {
    ...
    /// Crops the region the on-screen quadrat square was covering.
    ///
    ...
    ///
    /// - Parameters:
    ///   - squareSide: side length of the quadrat frame, in points
