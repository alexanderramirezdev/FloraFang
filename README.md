...
| **Exact Class Recall (Widow)** | **79.0%** | N/A | Create ML exact-class recall (true widow $\to$ predicted widow) |
| **Exact Class Recall (Recluse)** | **79.0%** | N/A | Create ML exact-class recall (true recluse $\to$ predicted recluse) |
